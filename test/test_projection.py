...
def test_next_position_when_special():
    records = [
        Transaction(
            date(2022, 2, 16),
            "FGH",
            ...
            amount=Amount(1),
            dividend=Amount(1),
            payout_date=date(2022, 2, 15),
            ex_date=date(2022, 2, 1),
        ),
        Transaction(
            date(2022, 3, 16),
            "FGH",
            ...
            amount=Amount(1),
            dividend=Amount(1),
            payout_date=date(2022, 3, 15),
            ex_date=date(2022, 3, 1),
        ),
        Transaction(
            date(2022, 3, 31),
            "FGH",
            ...
            dividend=Amount(0.5),
            kind=Distribution.SPECIAL,
            payout_date=date(2022, 3, 30),
            ex_date=date(2022, 3, 21),
        ),
        Transaction(
            date(2022, 4, 19),
            "FGH",
            ...
            amount=Amount(1),
            dividend=Amount(1),
            payout_date=date(2022, 4, 14),
            ex_date=date(2022, 4, 1),
        ),
        Transaction(
            date(2022, 5, 16),
            "FGH",
        ...
        Transaction(
            ...
            amount=Amount(1),
            dividend=Amount(1),
            payout_date=date(2022, 8, 15),
            ex_date=date(2022, 8, 1),
        ),
        Transaction(
            date(2022, 9, 16),
            "FGH",
            ...
            amount=Amount(1),
            dividend=Amount(1),
            payout_date=date(2022, 9, 15),
            ex_date=date(2022, 9, 1),
        ),
        Transaction(
            date(2022, 9, 28),
            "FGH",
            ...
            dividend=Amount(0.5),
            kind=Distribution.SPECIAL,
            payout_date=date(2022, 9, 27),
            ex_date=date(2022, 9, 19),
        ),
        Transaction(
            date(2022, 9, 29),
            "FGH",
        ...
        Transaction(
            ...
            amount=Amount(2),
            dividend=Amount(1),
            payout_date=date(2022, 10, 14),
            ex_date=date(2022, 10, 6),
        ),
        Transaction(
            date(2022, 11, 16),
            "FGH",
        ...
        Transaction(
            ...
            amount=Amount(2),
            dividend=Amount(1),
            payout_date=date(2023, 3, 15),
            ex_date=date(2023, 3, 7),
        ),
        Transaction(
            date(2023, 3, 16),
            "FGH",
        ...
        Transaction(
            ...
            dividend=Amount(0.5),
            kind=Distribution.SPECIAL,
            payout_date=date(2023, 3, 28),
            ex_date=date(2023, 3, 20),
        ),
    ]

    projections = scheduled_transactions(records, since=date(2023, 4, 1))
