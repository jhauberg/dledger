...
def test_intervals():
    ...
    records = [Transaction(date(2019, 1, 1), "ABC", 1)]
...
def test_in_period():
    ...
    assert len(list(in_period(records, (date(2019, 1, 1), date(2020, 1, 1))))) == 4
    assert len(list(in_period(records, (date(2019, 1, 1), date(2019, 12, 1))))) == 3
